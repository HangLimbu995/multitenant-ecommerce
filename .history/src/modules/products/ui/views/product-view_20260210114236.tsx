...
const CartButton = dynamic(() => import("../components/cart-button").then((mod) => mod.CartButton), {
    ...
    loading: () => (
        <Button
            variant="elevated"
            disabled
            className="flex-1 bg-pink-200 animate-pulse text-transparent"
        >
            Loading...
        </Button>
    )
                ...
                <div className="grid grid-cols-1 lg:grid-cols-6">
                    ...
                    <div className="col-span-2">
                        <div className="border-t lg:border-t-0 lg:border-l h-full">
                            ...
                            <div className="grid grid-cols-[auto_1fr_auto] gap-4 mt-4 pb-4 px-4">
                                {[5, 4, 3, 2, 1].map((stars) => (
                                    <Fragment key={stars}>
                                        <div className="font-medium">{stars} {stars === 1 ? 'star' : 'stars'}</div>
                                        <Progress value={data.ratingDistribution[stars]}
                                            className="h-[lh]" />
